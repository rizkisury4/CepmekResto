...
<html>
  ...
  <head>
    <title> Guest Login | Cepmek </title>
  </head>
...
<link href="https://fonts.googleapis.com/css?family=Bree+Serif&display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest,<br> Welcome to <span class="edit"> Cepmek </span></h1>
     <br>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="username" type="text" name="username" placeholder="enter a Username" required="" autofocus="">
